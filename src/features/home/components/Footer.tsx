...
const styles = {
  ...
  newsletterInput: "w-full border border-gray-300 dark:border-zinc-700 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-zinc-800 dark:text-white",
  subscribeBtn: "py-1.5 px-4 text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg shadow hover:scale-105 duration-200 cursor-pointer shrink-0",
