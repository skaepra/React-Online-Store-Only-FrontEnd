...
import { IoEyeOutline, IoHeartOutline, IoSparkles } from "react-icons/io5";
...
export default function Home() {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 transition-colors duration-200 min-h-screen">
      ...
      <div className="relative w-full h-[420px] sm:h-[480px] bg-[url(/toje.jpg)] bg-center bg-cover bg-no-repeat flex items-center justify-center">
              ...
              >
                ...
                <div className="relative aspect-square w-full overflow-hidden bg-gray-100 dark:bg-zinc-800">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      // Wishlist handler here if needed
                    }}
                    className="absolute top-3 right-3 p-2 rounded-full bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md text-gray-700 dark:text-gray-200 hover:text-rose-500 dark:hover:text-rose-400 transition-colors shadow-sm"
                  >
                ...
                {/* Details Content */}
                <div className="p-4 flex flex-col justify-between flex-grow space-y-2 bg-gray-50
                 dark:bg-zinc-800/60 ">
                  <div>
