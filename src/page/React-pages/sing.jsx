...
const Sing = () => {
    ...
    return (
      ...
      <div  className=" fixed top-0 left-0 right-0  h-screen text-white  w-fill flex justify-center items-center bg-[url(public/rthrhr.jfif)] bg-center   bg-cover bg- bg-no-repeat  "  >
  
  
    <div className=" space-y-3 border-2 border-[#9e9e9e]  p-5 w-[320px] h-[370px]  back rounded-lg">
    ...
    <div className=" flex  justify-center">
      <h1 className=" font-bold   mb-2 mr-1 text-2xl  text-white">Sing up</h1>
      </div>
      </div>
   ...
   <input type="text" name="Name" value={values.Name} onChange={onChangeHandler}
    ...
    disabled={values.Name==""||values.Name==""||values.Password==""||values.Remamper==false?true:false} 
    ...
    <div className="flex justify-center">
      ...
      <span className="text-[15px] ml-1  ">Sing in</span>
      </a>
